...
func TestCountTimeLines_ReturnsTotalCountForTotalTimelines(test *testing.T) {
	input := StringTo2DArray(`..S..
..^..
.^.^.
.....`)

	output := CountTimeLines(input)

	assert.Equal(test, 4, output, "Expected: 4, Received: %s", output)
...
...............`)
	...
	assert.Equal(test, 40, output, "Expected: 40, Received: %s", output)
}
...
func TestPart2_ReturnsTotal(test *testing.T) {
	input := `.......S.......
...............
.......^.......
...............
...
...............`
	...
	output = Part2(rawInput)

	assert.Equal(test, 16716444407407, output, "Expected: 16716444407407, Received: %s", output)
}